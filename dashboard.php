                ...
                <div id="menu">
                    ...
                    <div class="menu-section">
                        <a href="freelances.php"><img src="images/graph2 1.png" alt="Freelances">
                            <p class="menu-paragraph">Freelances</p>
                        </a>
                    </div>
                    <div class="menu-section">
                    ...
                    <div class="menu-section">
                        <a href="sousCategories.php"><img src="images/graph2 1.png" alt="sousCategory">
                            <p class="menu-paragraph">Sous Categories</p>
                        </a>
                    </div>
                    <div class="menu-section">
                ...
                <div id="content">
                    ...
                    <div class="row" id="mid-content">
                        <div class="col-6" id="clients-stats">
                            <div id="header">
                                <h3>Clients stats</h3>
                                <div style="background-color: white;padding-left: 10px;padding-right: 10px;padding-top: 3px;padding-bottom: 5px;border-radius: 10px;">
                                    <!-- <div class="time">
            <h2>Last 7 Days</h2>
            <img src="images/Polygon 4.svg" alt="down-arrow">
            </div> -->
